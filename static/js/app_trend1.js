...
var distance = d3.line()
    .x(function (d) { return x(d.date); })
    .y(function (d) { return y(d.distance); });

           

var distance2 = d3.line()
...
d3.csv("/static/data/data_trend.csv", function(error, data) {
  ...
  data.forEach(function(d) {
      ...
      d.distance = d.DistanceWalkingRunning ;
 ...
 mouseG.append('svg:rect') 
      ...
      .on('mousemove', function(d) { // mouse moving over canvas
        ...
        var idx = bisect(data, xDate);
         var distance = data[idx]['distance']
        ...
        d3.select(".mouse-line")
          .attr("d", function() {
            ...
            div.html("<p> <span style=color:green>  Distance Walked/Run: " + parseFloat(distance).toFixed(5)  + 
...
function brushed() {
  ...
  Line_chart.select(".distance").attr("d", distance);
